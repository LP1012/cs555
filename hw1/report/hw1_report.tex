...
Code: \url{https://github.com/LP1012/cs555/tree/main/hw1} \\
\noindent\rule{\linewidth}{2pt}
...
\begin{solution}
    ...
    The solver appears to struggle resolving the solution on the boundaries, resulting in rapid oscillations, though this problem appeared to lessen as the number of timesteps increased.
...
\begin{solution}
    ...
    This is shown in figure \cref{fig:growth-factors}.
    \begin{figure}[htbp]
        \centering
...
\begin{solution}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth]{../p3/part_2/3ii.png}
        \caption{Runtimes for ADI implementation of problem 3(ii) with varying number of spatial points, $N$.}
        \label{fig:adi-timings}
    \end{figure}
